...
print("Enter the function for F_0(x0, x1, x2, x3):")
F_0_expr = input("F_0: ")
print("Enter the function for F_1(x0, x1, x2, x3):")
F_1_expr = input("F_1: ")
print("Enter the function for F_2(x0, x1, x2, x3):")
F_2_expr = input("F_2: ")
print("Enter the function for F_3(x0, x1, x2, x3):")
F_3_expr = input("F_3: ")
...
def F_3(x0, x1, x2, x3):
    return eval(F_3_expr)

def product(u, v):
    """Defines the product (u0, u1, u2, u3) * (v0, v1, v2, v3) over GF(2) with x^4 + x + 1."""
    u0, u1, u2, u3 = u
    v0, v1, v2, v3 = v
    return (
        u0*v0 + u2*v2 + u1*v3 + u3*v1,
        u0*v1 + u1*v0 + u2*v2 + u1*v3 + u3*v1 + u2*v3 + u3*v2,
        u1*v1 + u2*v0 + u0*v2 + u2*v3 + u3*v2 + u3*v3,
        u2*v1 + u1*v2 + u0*v3 + u3*v0 + u3*v3
    )
